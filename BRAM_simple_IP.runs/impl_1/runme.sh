...
HD_PWD='D:/FPGA_Lab/BRAM/BRAM_simple_IP/BRAM_simple_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bram_ip_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_bram_ip_example.tcl -notrace
