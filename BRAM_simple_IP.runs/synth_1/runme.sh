...
HD_PWD='D:/FPGA_Lab/BRAM/BRAM_simple_IP/BRAM_simple_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bram_ip_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bram_ip_example.tcl
